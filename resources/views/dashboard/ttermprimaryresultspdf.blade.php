                    ...
                    <div class="fterm">
                        <table id="myTable">
                            <tr>
                              ...
                              <th>1<sup>1st</sup> Term <br>Total </th>
                            </tr>
                       @php
                           $total_score1 = 0;
                       @endphp
                       ...
                       @endphp
                            @foreach ($secondterm_results as $secondterm_result)
                                @if ($secondterm_result->status == 'approved')
                                    @php
                                    $total_score2 +=$secondterm_result->test_1 + $secondterm_result->test_2 + $secondterm_result->test_3 + $secondterm_result->exams;
                                @endphp
                          
                             {{-- <tr > --}}
                              
                              <td class="hide">{{ $secondterm_result->test_1 + $secondterm_result->test_2 + $secondterm_result->test_3 + $secondterm_result->exams}}</td>
                       ...
                       @endphp
                            @foreach ($getyour_results as $getyour_result)
                             ...
                             {{-- <tr > --}}
                              ...
                              <td class="hide">{{ $getyour_result->test_1 + $getyour_result->test_2 + $getyour_result->test_3 + $firstterm_result->exams}}</td>
                ...
                <div class="term3">
                    <div class="fterm">
                        <table id="myTable">
                            ...
                            <td>{{ $total_score + $total_score2 + $total_score1 / 100  }}</td>
                ...
                <div class="term3">
                    <div class="fterm">
                        <table id="myTable">
                            ...
                            <td>{{ $total_score + $total_score2 + $total_score1 / 2  }}</td>
