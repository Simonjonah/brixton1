                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="title" class="form-control" id="">
                          <option value="{{ $edit_gallery->title }}">{{ $edit_gallery->title }}</option>
                          <option value="Future Management">Future Management</option>
                          <option value="Events">Events</option>
                          <option value="Sport Activities">Sport Activities</option>
                          <option value="Music Classes">Music Classes</option>
                          <option value="Reading/Spelling Classes">Reading/Spelling Classes</option>
                          <option value="Art-Classes">Art-Classes</option>
                          <option value="Creative Classes">Creative Classes</option>
