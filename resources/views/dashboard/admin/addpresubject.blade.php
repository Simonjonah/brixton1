                    ...
                    <div class="col-lg-6 col-md-6 col-sm-23">
                      <div class="form-group">
                        ...
                        <select required class="form-control" type="text" name="category">
                          ...
                          <option value="LITERACY/PHONICS">LITERACY/PHONICS</option>
                          <option value="NUMERACY/MATHEMATICS">NUMERACY/MATHEMATICS</option>
                          <option value="UNDERSTANDING OF THE WORLD">UNDERSTANDING OF THE WORLD</option>
                        </select>
                      </div> 
                    </div>
