            	...
            	<div class="row clearfix">
                    ...
                    <div class="big-column col-lg-6 col-md-12 col-sm-12">
						<div class="row clearfix">
                        	...
                        	<!--Footer Column https://cpanel-p205.web-hosting.com   IMFI EMAIL PASSWORD imfiacacademy@12-->
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									<div class="logo">
										<a href="home"><img style="height: 70px; width: 200px;" src="{{ asset('images/sch14.jpg') }}" alt="" /></a>
									</div>
									<div class="text">For additional information on BRIXTONN SCHOOLS services, please contact us using the information below:</div>
									<ul class="list-style-two">
										<li>Uyo Centre: <span class="icon fa fa-phone"></span>+234 808 908 0898  <br>+234 905 912 5383 </li>
										<li>Abuja Centre: <span class="icon fa fa-phone"></span>+234 912 439 8085</li>
										<li><span class="icon fa fa-home"></span>No 4, Julius Nyerere Crescent. Asokoro Abuja, Asokoro, Nigeria <br>
                      					 </li>
										...
										<li><span class="icon fa fa-home"></span>Brixtonn High School, Unit 8 B-Line Ewet Housing Estate, Uyo <br> Akwa Ibom, Nigeria</li>
			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="copyright-column col-lg-6 col-md-6 col-sm-12">
						<div class="copyright">2021 &copy; All rights reserved by <a href="https://web.facebook.com/?_rdc=1&_rdr">Knowledge Guide Concept</a></div>
					</div>
