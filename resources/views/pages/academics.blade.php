	...
	<section class="services-section-ten style-two">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				...
				<div class="title">BRIXTONN SCHOOLS <br> LEARNING IN CREATIVITY</div>
			</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="nurseryform">CRECHE SECTION </a></h5>
							</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="nurseryform">PRE-NURSERY SECTION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="600ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="nurseryform">PREPERATORY SECTION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="nurseryform">NURSERY SECTION </a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
				...
				<div class="services-block-fifteen col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow bounceIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								<div class="icon flaticon-data"></div>
								<h5><a href="nurseryform">PRIMARY SECTION </a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="nurseryform">EXTRA CURRICULA ACTIVITIES</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
				...
				<div class="services-block-fifteen col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								<div class="icon flaticon-hand-shake-1"></div>
								<h5><a href="nurseryform">COMPUTER EXHIBITION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
				...
				<div class="services-block-fifteen col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								<div class="icon flaticon-hand-shake-1"></div>
								<h5><a href="nurseryform">INTELLIGENCE REASONING SECTION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
