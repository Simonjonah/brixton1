					...
					<div class="inner-box wow bounceIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="contact">CRECHE SECTION </a></h5>
							</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="contact">PRE-NURSERY SECTION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="600ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="contact">PREPARATORY SECTION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="contact">NURSERY SECTION </a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
				...
				<div class="services-block-fifteen col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow bounceIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								<div class="icon flaticon-data"></div>
								<h5><a href="contact">PRIMARY SECTION </a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
					...
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								...
								<h5><a href="contact">EXTRA CURRICULAR ACTIVITIES</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
				...
				<div class="services-block-fifteen col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								<div class="icon flaticon-hand-shake-1"></div>
								<h5><a href="contact">COMPUTER EXHIBITION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
				...
				<div class="services-block-fifteen col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow bounceIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<div class="upper-box">
								<div class="icon flaticon-hand-shake-1"></div>
								<h5><a href="contact">INTELLIGENCE REASONING SECTION</a></h5>
							</div>
							{{-- <div class="text">Excepteur sint occaecat cupidatat non proi dent, sunt in culpa qui officia deserunt mollit anim id est laborum</div> --}}
						</div>
					</div>
