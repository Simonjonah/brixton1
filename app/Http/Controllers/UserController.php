...
class UserController extends Controller
{
   ...
   public function viewstudents($ref_no){
    ...
    public function studentsaddmithead($ref_no){
        $admit_student = User::where('ref_no', $ref_no)->first();
        $admit_student->status = 'admitted';
        $admit_student->save();
        return redirect()->back()->with('success', 'you have approved successfully');
    ...
    public function admittedstudents(){
        $admit_students = User::where('status', 'admitted')->where('assign1', 'student')->get();
    ...
    public function preschoolpupils(){
        $view_classess = Classname::all();
        $view_preschoolstudents = User::where('section', 'Pre-School')->latest()->get();
    ...
    public function preschoolsection(){
        $view_classess = Classname::all();
        $view_preschstudents = User::where('section', 'Pre-School')->latest()->get();
